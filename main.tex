...
\begin{publicationpage}{Waszkiewicz_2021_stability}{Stability of sedimenting flexible loops}
    \commentary{
        ...
        To address this concern, we focused on an idealised problem involving the sedimentation of a circular fibre, aiming to eliminate end-corrections from the consideration of buckling.
        ...
        Third, they prepared all visualisations (2D and 3D).
    }
\end{publicationpage}
...
\begin{publicationpage}{Waszkiewicz_2021_hydrodynamic}{Hydrodynamic effects in the capture of rod-like molecules by a nanopore}
    \commentary{
        ...
        Existing capture models often overlook hydrodynamic interactions, a significant factor when the DNA fragment is sufficiently close to the nanopore.
        ...
        In this study, the PhD candidate prepared all numerical results and visualisations.
...
\begin{publicationpage}{Waszkiewicz_2023_dna}{DNA supercoiling-induced shapes alter minicircle hydrodynamic properties}
    \commentary{
        ...
        Third, the candidate produced all graphs and visualisations incorporated in the manuscript.
    }
\end{publicationpage}
...
\begin{publicationpage}{Waszkiewicz_2024_mda}{Minimum dissipation approximation: A fast algorithm for the prediction of diffusive properties of intrinsically disordered proteins}
    \commentary{
        ...
        The first group, specialising in theoretical modelling, included Bogdan Cichocki (PhD candidate), along with Maciej Lisicki and Piotr Szymczak from the Warsaw University Physics Department.
        ...
        Second, the implementation of the python port \code{pygrpy} of the generalised Rotne-Prager mobility tensors (originally implemented in Fortran\cite{Zuk_2018}).
