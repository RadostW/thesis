...
\begin{publicationpage}{Waszkiewicz_2021_stability}
    \commentary{TODO.
        Performing theoretical calculations numerical investigation and visualisations.
...
\begin{publicationpage}{Waszkiewicz_2021_hydrodynamic}
    \commentary{TODO
        Performing numerical investigation and visualisations.
        Performing scaling analysis in collaboration with Maciej Lisicki.
...
\begin{publicationpage}{Waszkiewicz_2023_dna}
    \commentary{TODO
        Designing numerical pipeline and performing computations leading
        to the equilibrium configurations of the supercoiled DNA minicircles.
        Computing hydrodynamic properties of these configurations using GRPY, pygrpy and Zeno software (only Zeno is included in the published manuscript).
        Producing graphs and visualisations included in the manuscript.
    }
\end{publicationpage}
...
\begin{publicationpage}{Waszkiewicz_2023_pychastic}
    \commentary{TODO
        Leading a small programming team (the author, Maciej Bartczak, Kamil Kolasa)
        to produce a complex python package (including documentation, examples and tests).
        Designing illustrative examples (in collaboration with Maciej Lisicki), test cases and debug tools which allowed for corrections of multiple typos in the available literature.
    }
\end{publicationpage}
...
\begin{publicationpage}{Waszkiewicz_2024_mda}
    \commentary{TODO
        ...
        In particular: design of the globule-linker conformer generation scheme, investigation of Flexible Meccano conformer generation scheme, implementation of the python port \code{pygrpy} of the generalized Rotne-Prager mobility tensors (originally implemented in Fortran\cite{Zuk_2018}).
        Statistical analysis of the theory--experiment deviations.
    }
\end{publicationpage}
...
The results of this thesis show that such unified approach is possible and predicts diffusion coefficients of macromolecules with good precision.
