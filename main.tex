...
\begin{publicationpage}{Waszkiewicz_2021_hydrodynamic}{Hydrodynamic effects in the capture of rod-like molecules by a nanopore}
    \commentary{
        ...
        \ml{Propozycja ML:} {Translocation of biomolecules through nanopores lies at the heart of many biological processes, such as cell signalling.
...
\begin{publicationpage}{Waszkiewicz_2023_pychastic}{Pychastic: Precise Brownian dynamics using Taylor-Ito integrators in Python}
    \commentary{
        ...
        In the process of preparing the forthcoming publication, the PhD candidate lead a small programming team, which included the author, Maciej Bartczak, and Kamil Kolasa.
        Their objective was to develop a Python package complete with documentation, examples, and tests.
        The candidate also created test cases and debugging tools that facilitated the correction of multiple typos found in existing literature (outlined in the publication).
...
\begin{publicationpage}{Waszkiewicz_2024_mda}{Minimum dissipation approximation: A fast algorithm for the prediction of diffusive properties of intrinsically disordered proteins}
    \commentary{
        ...
        The first group, specialising in theoretical modelling, included PhD candidate, Bogdan Cichocki, along with Maciej Lisicki and Piotr Szymczak from the Warsaw University Physics Department.
