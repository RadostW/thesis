...
\begin{publicationpage}{Waszkiewicz_2021_stability}
    ...
    In particular: performing linear stability analysis of the PDE describing the shape 
    of the flexible filament including the projection method which allows for near analytical 
    treatment of the eigenvalue problem, analysis of the resulting matrix problem, preparing 
    the numerical solver based on truncated Fourier series, performing numerical investigation 
...
\begin{publicationpage}{Waszkiewicz_2021_hydrodynamic}
    \commentary{TODO
    Performing numerical investigation and visualisations. Performing scaling analysis in 
    collaboration with Maciej Lisicki. In particular: The Mathematica implementation of the
    near-wall corrections to the mobility tensor\cite{Lisicki_2016}, computation of the 
    trajectories of the colloid.}
\end{publicationpage}
...
\begin{publicationpage}{Waszkiewicz_2023_dna}
    ...
    Computing hydrodynamic properties of these configurations using GRPY, 
    pygrpy and Zeno software (only Zeno is included in the published manuscript). 
...
\begin{publicationpage}{Waszkiewicz_2023_pychastic}
    ...
    Designing illustrative examples (in collaboration with Maciej Lisicki), test cases 
    and debug tools which allowed for corrections of multiple typos in the available literature.
    }
\end{publicationpage}
...
\begin{publicationpage}{Waszkiewicz_2024_mda}
    \commentary{TODO
    Implementation of the numerical methods. In particular: design of the globule-linker 
    conformer generation scheme, investigation of Flexible Meccano conformer generation scheme, 
    implementation of the python port \code{pygrpy} of the generalized Rotne-Prager mobility 
    tensors (originally implemented in Fortran\cite{Zuk_2018}). Statistical analysis of the 
    theory--experiment deviations.}
\end{publicationpage}
